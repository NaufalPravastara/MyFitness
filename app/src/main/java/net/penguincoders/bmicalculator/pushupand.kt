...
class pushupand : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_pushupand)
        ...
        vVideo!!.setVideoURI(Uri.parse("android.resource://" + packageName + "/" + R.raw.pushuprotate))
